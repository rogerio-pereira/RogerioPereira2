...
<head>
    ...
    <title>Unsubscribe - Rogerio Pereira</title>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="content-box">
                ...
                <p>We're sorry to see you go. If you unsubscribe, you'll no longer receive emails from us.</p>
                
                <p>Are you sure you want to unsubscribe from our email list?</p>
                
                <div class="button-group">
                    <form action="{{ route('unsubscribe.confirm', $contact->id) }}" method="POST" style="display: inline;">
                        @csrf
